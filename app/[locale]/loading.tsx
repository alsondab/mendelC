      ...
      <div className='fixed top-0 left-0 right-0 h-[2px] z-[100] bg-border/20'>
        <div
          ...
          style={{
            ...
            filter: 'blur(0.5px)',
            animation: 'progress-loading 1.2s cubic-bezier(0.43, 0.13, 0.23, 0.96) infinite',
          }}
        />
      </div>
      <style jsx>{`
      ...
      <div className='border-b bg-card/50 animate-in fade-in duration-300 delay-100'>
        <div className='container mx-auto px-4 py-2'>
          <div className='flex items-center gap-6'>
            {[...Array(6)].map((_, i) => (
              <div key={i} className='animate-in fade-in slide-in-from-bottom-4 duration-300' style={{ animationDelay: `${i * 100}ms` }}>
                <Skeleton className='h-6 w-20' />
              </div>
            ))}
          </div>
      ...
      <div className='container mx-auto px-4 py-8 space-y-8'>
        ...
        <div className='space-y-4 animate-in fade-in duration-300 delay-300'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
            {[...Array(8)].map((_, i) => (
              <div key={i} className='space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-300' style={{ animationDelay: `${300 + i * 50}ms` }}>
        ...
        {[...Array(3)].map((_, sectionIndex) => (
          <div key={sectionIndex} className='space-y-4 animate-in fade-in duration-300' style={{ animationDelay: `${400 + sectionIndex * 100}ms` }}>
            <div className='flex items-center justify-between'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4'>
              {[...Array(5)].map((_, i) => (
                <div
                  ...
                  style={{ animationDelay: `${400 + sectionIndex * 100 + i * 50}ms` }}
                >
      ...
      <div className='border-t bg-card mt-16 animate-in fade-in duration-300 delay-700'>
        <div className='container mx-auto px-4 py-8'>
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            {[...Array(4)].map((_, i) => (
              <div key={i} className='space-y-3 animate-in fade-in duration-300' style={{ animationDelay: `${700 + i * 100}ms` }}>
                <Skeleton className='h-5 w-24' />
                {[...Array(4)].map((_, j) => (
                  <div key={j} className='animate-in fade-in slide-in-from-bottom-4 duration-300' style={{ animationDelay: `${700 + i * 100 + j * 50}ms` }}>
