...
const products: IProductInput[] = [
  {
    ...
    compatibility: ['Hikvision NVR', 'Universal ONVIF', 'Hikvision App', 'Web Browser'],
    colors: ['White', 'Black'],
    reviews: [],
  },
  {
  ...
  },
  {
    ...
    compatibility: ['Windows', 'macOS', 'Linux', 'Universal', 'HDMI 1.4', 'VGA'],
    colors: ['Black', 'Silver'],
    reviews: [],
  },
  {
    ...
    compatibility: ['Windows 11', 'Universal', 'Dell Support', 'Enterprise Software'],
    colors: ['Black'],
    reviews: [],
  },
  {
  ...
  },
  {
    ...
    compatibility: ['Cisco Call Manager', 'Universal SIP', 'Cisco IP Communicator', 'Web Browser'],
    colors: ['Black'],
    reviews: [],
  },
  {
    ...
    compatibility: ['Universal', 'Commercial Use', 'Residential Use', 'Vehicle Use'],
    colors: ['Red'],
    reviews: [],
  },
  {
    ...
    compatibility: ['Universal', 'Residential Use', 'Commercial Use', '9V Battery'],
    colors: ['White'],
    reviews: [],
  },
  {
    ...
    compatibility: ['Windows 11', 'Universal', 'Lenovo Vantage', 'Enterprise Software'],
    colors: ['Black'],
    reviews: [],
  },
  {
    ...
    compatibility: ['Windows', 'macOS', 'Linux', 'Universal', 'SATA III', 'Backward Compatible'],
    colors: ['Black'],
    reviews: [],
  },
]
