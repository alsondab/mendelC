...
const products: IProductInput[] = [
  ...
  },
  {
    ...
    specifications: [
      { name: 'Material', value: 'Heavyweight Blend Cotton' },
      { name: 'Fit', value: 'Regular Fit' },
      { name: 'Sleeve Length', value: 'Long Sleeve' },
      { name: 'Features', value: 'Shoulder-to-shoulder tape, Double-needle coverstitched' }
    ],
    compatibility: ['Printing', 'Embroidery', 'Custom designs', 'Workwear'],
    reviews: [],
  },
  {
