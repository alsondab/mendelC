...
const main = async () => {
  try {
    ...
    const categorySlugToId = createdMainCategories.reduce((acc, cat) => {
    ...
    const createdSubCategories = await Category.insertMany(subCategoriesWithParentIds)
    const createdCategories = [...createdMainCategories, ...createdSubCategories]
