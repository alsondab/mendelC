...
const updateProductAfterPromotionExpiry = async (product: ProductWithPromotion) => {
  try {
...
const determineNewTags = async (product: ProductWithPromotion, currentTags: string[]) => {
