...
const addStockFields = (product: any): IProductInput => ({
  ...product,
  minStockLevel: 5,
  maxStockLevel: 100,
...
const products: IProductInput[] = productsData.map(addStockFields)
  ...
  settings: [
    {
      ...
      site: {
        ...
        email: 'info@mendel-corp.com',
        address: "Abidjan Côte d'Ivoire",
        phone: '+225 0707 5821 91',
      },
      carousels: [
        {
          title: 'Systèmes de surveillance vidéo professionnels',
