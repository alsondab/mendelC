            ...
            <Section className='px-6 pb-8'>
              ...
              <div className='space-y-4'>
                {order.items.map((item, index) => (
                  <div key={item.product} className='bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl p-6 shadow-sm hover-lift'>
              ...
              <div className='bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 shadow-lg'>
                ...
                <div className='space-y-4'>
                  <div className='flex justify-between items-center py-3 border-b border-blue-200'>
                    <Text className='text-slate-700 font-medium text-lg m-0'>Items Subtotal</Text>
                    <Text className='text-slate-900 font-semibold text-lg m-0'>{formatCurrency(order.itemsPrice)}</Text>
                  </div>
                  <div className='flex justify-between items-center py-3 border-b border-blue-200'>
                    <Text className='text-slate-700 font-medium text-lg m-0'>Shipping & Handling</Text>
                    <Text className='text-slate-900 font-semibold text-lg m-0'>{formatCurrency(order.shippingPrice)}</Text>
                  </div>
                  <div className='flex justify-between items-center py-3 border-b border-blue-200'>
                    <Text className='text-slate-700 font-medium text-lg m-0'>Tax</Text>
                    <Text className='text-slate-900 font-semibold text-lg m-0'>{formatCurrency(order.taxPrice)}</Text>
                  </div>
