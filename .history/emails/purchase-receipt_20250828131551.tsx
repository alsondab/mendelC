              ...
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <Text className="text-gray-900 m-0">{formatCurrency(order.itemsPrice)}</Text>
                  </div>
                  <div className="flex justify-between">
                    <Text className="text-gray-600 m-0">Shipping & Handling</Text>
                    <Text className="text-gray-900 m-0">{formatCurrency(order.shippingPrice)}</Text>
                  </div>
                  <div className="flex justify-between">
                    <Text className="text-gray-600 m-0">Tax</Text>
                    <Text className="text-gray-900 m-0">{formatCurrency(order.taxPrice)}</Text>
                  </div>
