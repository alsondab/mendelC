  ...
  return (
    <div className='flex items-center gap-4'>
      ...
      <div className='flex gap-3'>
        ...
        <div className='text-center'>
          <div className='text-2xl font-bold text-green-600'>{timeLeft.hours.toString().padStart(2, '0')}</div>
          <div className='text-xs text-green-700'>Heures</div>
        </div>
        <div className='text-center'>
          <div className='text-2xl font-bold text-green-600'>{timeLeft.minutes.toString().padStart(2, '0')}</div>
          <div className='text-xs text-green-700'>Minutes</div>
        </div>
        <div className='text-center'>
          <div className='text-2xl font-bold text-green-600'>{timeLeft.seconds.toString().padStart(2, '0')}</div>
