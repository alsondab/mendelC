      ...
      if (isInWishlistState) {
        ...
        if (session?.user?.id) {
          ...
          if (result.success) {
            ...
            toast({
              title: 'Favori ajouté',
              description: 'Le produit a été ajouté à vos favoris et synchronisé avec votre compte.',
            })
            window.dispatchEvent(new CustomEvent('wishlistChanged'))
          } else {
            toast({
          ...
          if (product) {
            ...
            toast({
              title: 'Favori ajouté',
              description: 'Le produit a été ajouté à vos favoris. Connectez-vous pour synchroniser avec votre compte.',
            })
            window.dispatchEvent(new CustomEvent('wishlistChanged'))
          } else {
            toast({
