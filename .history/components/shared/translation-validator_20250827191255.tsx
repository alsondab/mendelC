...
} from '@/hooks/use-translation-validator'
...
export default function TranslationValidator({
  ...
  const [expandedTranslations, setExpandedTranslations] = React.useState<
    Set<string>
  >(new Set())
  const [translationInputs, setTranslationInputs] = React.useState<
    ...
    return (
      <Alert className='border-green-200 bg-green-50'>
        ...
        <AlertDescription className='text-green-700'>
          Aucune traduction manquante détectée. Votre site est prêt pour toutes
          les langues.
        </AlertDescription>
      </Alert>
    )
    ...
    <Card className='border-orange-200 bg-orange-50'>
      <CardHeader className='pb-3'>
        ...
        <p className='text-sm text-orange-700'>
          Ces éléments n&apos;ont pas de traduction et causeront des erreurs sur
          votre site.
        </p>
      </CardHeader>
      ...
      <CardContent className='space-y-4'>
                  ...
                  <div className='grid grid-cols-2 gap-3'>
                    <div>
                      ...
                      <Input
                        ...
                        value={inputs.fr}
                        onChange={(e) =>
                          updateTranslationInput(key, 'fr', e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        value={inputs.en}
                        onChange={(e) =>
                          updateTranslationInput(key, 'en', e.target.value)
                        }
        ...
        <div className='flex justify-between items-center'>
          <p className='text-sm text-orange-700'>
            Cliquez sur <Plus className='h-3 w-3 inline' /> pour ajouter les
