            ...
            <div className='flex items-center'>
              ...
              <DrawerClose asChild>
                <Link
                  ...
                  className='flex-1 flex items-center justify-between px-3 py-2 hover:bg-muted/50 transition-colors group'
                >
              ...
              {hasSubCategories && (
                <button
                  ...
                  className='px-2 py-2 hover:bg-muted/30 transition-colors flex items-center justify-center group'
                  aria-label={
                    isOpen
                  ...
                  {category.subCategories.map((subCategory) => (
                    <DrawerClose asChild key={subCategory._id}>
                      <Link
                        ...
                        className='flex items-center justify-between px-3 py-2 hover:bg-muted/30 transition-colors text-xs text-muted-foreground hover:text-foreground group'
                      >
                        <div className='flex items-center gap-2'>
