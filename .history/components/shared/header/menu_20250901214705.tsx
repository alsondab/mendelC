          ...
          <Sheet>
            ...
            <SheetContent side='bottom' className='h-[80vh] rounded-t-xl'>
              <SheetHeader className='space-y-4'>
                <SheetTitle className='text-left'>Panneau d'administration</SheetTitle>
                  ...
                  {[
                    ...
                    return (
                      <Link
                        key={item.href}
                        href={item.href}
                        className='flex flex-col items-center space-y-2 p-4 rounded-lg border transition-all duration-200 bg-muted/50 hover:bg-muted border-border hover:shadow-sm'
                      >
