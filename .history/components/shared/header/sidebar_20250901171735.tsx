...
import { X, ChevronRight, UserCircle, MenuIcon, ShoppingBag } from 'lucide-react'
...
export default async function Sidebar({
  ...
  return (
    <Drawer direction={getDirection(locale) === 'rtl' ? 'right' : 'left'}>
      <DrawerTrigger className='flex items-center space-x-2 px-3 py-2 rounded-lg hover:bg-muted/80 transition-colors text-sm font-medium'>
