      ...
      <div className='border-t border-slate-800 bg-slate-950'>
        <div className='max-w-7xl mx-auto px-4 py-6'>
          <div className='flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0'>
            ...
            <div className='flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-8 text-slate-400 text-sm'>
              <Link
                href='/conditions-utilisation'
                className='hover:text-orange-500 transition-colors px-3 py-1 rounded-md hover:bg-slate-800/50'
              >
