              ...
              <ul className='space-y-2'>
                <li>
                  <Link
                    ...
                    className='text-slate-400 hover:text-white text-sm flex items-center space-x-2 whitespace-nowrap'
                  >
                    <Truck className='h-4 w-4 flex-shrink-0' />
                    <span className='truncate'>Tarifs et politiques d&apos;expédition</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span className='truncate'>Retours et remplacements</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span className='truncate'>Questions fréquentes</span>
                  </Link>
                </li>
                <li>
                  <Link
