      ...
      <div className='space-y-3 sm:space-y-4'>
        <div className='grid gap-2 sm:gap-4 grid-cols-1 xs:grid-cols-2 lg:grid-cols-4'>
          ...
          <Card className='min-h-[120px]'>
            ...
            <CardContent className='space-y-2'>
              <div className='text-lg sm:text-2xl font-bold'>{data.usersCount}</div>
              <div>
          ...
          <Card className='min-h-[120px]'>
            ...
            <CardContent className='space-y-2'>
              <div className='text-lg sm:text-2xl font-bold'>{data.productsCount}</div>
              <div>
        ...
        <div>
          <Card>
            <CardHeader className='pb-3'>
              <CardTitle className='text-base sm:text-lg'>{t('Sales Overview')}</CardTitle>
            </CardHeader>
        ...
        <div className='grid gap-3 sm:gap-4 grid-cols-1 lg:grid-cols-2'>
          <Card>
            <CardHeader className='pb-3'>
              <CardTitle className='text-sm sm:text-base'>{t('How much you are earning')}</CardTitle>
          ...
          <Card>
            <CardHeader className='pb-3'>
              <CardTitle className='text-sm sm:text-base'>{t('Product Performance')}</CardTitle>
              <CardDescription className='text-xs sm:text-sm'>
        ...
        <div className='grid gap-3 sm:gap-4 grid-cols-1 lg:grid-cols-2'>
          <Card>
            <CardHeader className='pb-3'>
              <CardTitle className='text-sm sm:text-base'>{t('Best-Selling Categories')}</CardTitle>
            </CardHeader>
            <CardContent className='p-3 sm:p-6'>
          ...
          <Card>
            <CardHeader className='pb-3'>
              <CardTitle className='text-sm sm:text-base'>{t('Recent Sales')}</CardTitle>
            </CardHeader>
            <CardContent className='p-3 sm:p-6'>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className='text-xs sm:text-sm'>{t('Total')}</TableHead>
