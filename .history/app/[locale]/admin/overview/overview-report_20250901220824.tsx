    ...
    <div className='p-2 sm:p-4'>
      ...
      <div className='space-y-4'>
        ...
        <div>
          <Card className='p-3 sm:p-6'>
            <CardHeader className='px-0'>
              <CardTitle className='text-lg sm:text-xl'>{t('Sales Overview')}</CardTitle>
            </CardHeader>
        ...
        <div className='grid gap-3 sm:gap-4 grid-cols-1 md:grid-cols-2'>
          <Card className='p-3 sm:p-6'>
            <CardHeader className='px-0'>
              <CardTitle className='text-base sm:text-lg'>{t('How much you're earning')}</CardTitle>
          ...
          <Card className='p-3 sm:p-6'>
            <CardHeader className='px-0'>
              <CardTitle className='text-base sm:text-lg'>{t('Product Performance')}</CardTitle>
              <CardDescription className='text-xs sm:text-sm'>
        ...
        <div className='grid gap-3 sm:gap-4 grid-cols-1 md:grid-cols-2'>
          <Card className='p-3 sm:p-6'>
            <CardHeader className='px-0'>
              <CardTitle className='text-base sm:text-lg'>{t('Best-Selling Categories')}</CardTitle>
            </CardHeader>
            <CardContent className='px-0'>
              <div className='h-64 sm:h-80'>
          ...
          <Card className='p-3 sm:p-6'>
            <CardHeader className='px-0'>
              <CardTitle className='text-base sm:text-lg'>{t('Recent Sales')}</CardTitle>
            </CardHeader>
            <CardContent className='px-0'>
