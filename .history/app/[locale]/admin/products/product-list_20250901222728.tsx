          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className='text-right text-xs sm:text-sm'>Prix</TableHead>
                <TableHead className='hidden sm:table-cell text-xs sm:text-sm'>Catégorie</TableHead>
                <TableHead className='hidden md:table-cell text-xs sm:text-sm'>Stock</TableHead>
                <TableHead className='hidden lg:table-cell text-xs sm:text-sm'>Note</TableHead>
                <TableHead className='hidden md:table-cell text-xs sm:text-sm'>Statut</TableHead>
                <TableHead className='hidden lg:table-cell text-xs sm:text-sm'>Dernière MAJ</TableHead>
