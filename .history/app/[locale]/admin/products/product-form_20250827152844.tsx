                ...
                <FormControl>
                  <div className='space-y-2'>
                    {field.value.map((item, index) => (
                      <div key={index} className='flex gap-2'>
                        <Input
                          placeholder='Compatibility item'
                          value={item}
                          onChange={(e) => {
                            const newCompatibility = [...field.value]
                            newCompatibility[index] = e.target.value
                            field.onChange(newCompatibility)
                          }}
                        />
                        <Button
                          type='button'
                          ...
                          size='sm'
                          onClick={() => {
                            const newCompatibility = field.value.filter((_, i) => i !== index)
                            field.onChange(newCompatibility)
                          }}
                        >
                          Remove
