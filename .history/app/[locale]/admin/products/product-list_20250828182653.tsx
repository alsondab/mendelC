            ...
            <TableBody>
              {data?.products.map((product: IProduct) => (
                <TableRow key={product._id}>
                  ...
                  <TableCell>
                    <div className={`flex items-center gap-2 ${product.isPublished ? 'text-green-600' : 'text-red-600'}`}>
                      <div className={`w-2 h-2 rounded-full ${product.isPublished ? 'bg-green-500' : 'bg-red-500'}`}></div>
                  ...
                  <TableCell className='flex gap-1'>
                    ...
                    <Button 
                      ...
                      title={product.isPublished ? 'View product' : 'Product not published'}
                      className={!product.isPublished ? 'opacity-50 cursor-not-allowed' : ''}
                    >
                      <Link target='_blank' href={product.isPublished ? `/product/${product.slug}` : '#'}>
