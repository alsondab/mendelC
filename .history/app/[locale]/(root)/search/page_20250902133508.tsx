        ...
        <CollapsibleOnMobile title={t('Search.Filters')}>
            ...
            <div>
                  ...
                  <Link
                    ...
                    href={getFilterUrl({ category: 'all', subCategory: 'all', params })}
                  >
                    {t('Search.All')}
                  </Link>
                {categories.map((cat) => (
                  <div key={cat._id}>
                    <Link
                      ...
                      href={getFilterUrl({ category: cat.name, subCategory: 'all', params })}
                    >
                      {cat.name}
                    </Link>
                    {/* Subcategories */}
                        ...
                        {cat.subCategories.map((subCat) => (
                          <Link
                            ...
                            className={`block px-3 py-1 rounded-lg text-xs transition-colors ${
                              subCat.name === subCategory && cat.name === category
                                ? 'bg-primary/80 text-primary-foreground font-medium'
                                : 'hover:bg-muted/50 text-muted-foreground hover:text-foreground'
                            }`}
                            href={getFilterUrl({ category: cat.name, subCategory: subCat.name, params })}
                          >
                            └ {subCat.name}
                          </Link>
                        ))}
