            ...
            <CardContent className='p-4 xs:p-6'>
              <div className='mb-6'>
                <p className='text-sm xs:text-base text-muted-foreground leading-relaxed'>
                  Si vous souhaitez modifier le nom associé à votre compte {site.name},
                  vous pouvez le faire ci-dessous. Assurez-vous de cliquer sur le bouton
                  &quot;Enregistrer les modifications&quot; lorsque vous avez terminé.
                </p>
              </div>
              <ProfileForm />
            </CardContent>
