          ...
          <Table>
            <TableHeader>
              <TableRow className='border-border/50'>
                ...
                <TableHead className='text-xs sm:text-sm font-semibold hidden sm:table-cell'>Payé</TableHead>
                <TableHead className='text-xs sm:text-sm font-semibold hidden sm:table-cell'>Livré</TableHead>
