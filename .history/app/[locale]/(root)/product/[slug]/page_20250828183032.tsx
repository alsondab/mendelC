...
export async function generateMetadata(props: {
  ...
  const { product, isPublished, exists } = await getProductBySlugWithStatus(params.slug)
...
export default async function ProductDetails(props: {
  ...
  const { product: productData, isPublished, exists } = await getProductBySlugWithStatus(slug)
  ...
  if (!isPublished) {
    ...
    throw new Error('Product exists but is not published. Please contact an administrator.')
  }
