    ...
    <div className='p-2 sm:p-4 lg:p-6 max-w-7xl mx-auto'>
              ...
              <CardContent className='p-6 space-y-4'>
                ...
                <div className='text-center'>
                  {product.countInStock > 0 && product.countInStock <= 3 && (
                    <div className='inline-flex items-center gap-2 px-3 py-2 rounded-full bg-orange-100 text-orange-800 text-sm font-semibold mb-2'>
                  ...
                  {product.countInStock !== 0 ? (
                    <div className='inline-flex items-center gap-2 px-3 py-2 rounded-full bg-green-100 text-green-800 text-sm font-semibold'>
                      <div className='w-2 h-2 bg-green-500 rounded-full'></div>
                      {t('Product.In Stock')}
                    </div>
                  ) : (
                    <div className='inline-flex items-center gap-2 px-3 py-2 rounded-full bg-red-100 text-red-800 text-sm font-semibold'>
      ...
      <section className='mt-12 mb-12'>
        <div className='bg-gradient-to-r from-primary/5 to-primary/10 rounded-xl p-6 mb-6'>
          <h2 className='text-2xl font-bold mb-2 text-center' id='reviews'>
