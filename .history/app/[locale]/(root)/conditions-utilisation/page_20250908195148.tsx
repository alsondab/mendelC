        ...
        <div className='space-y-8'>
          <section className='bg-muted/50 p-6 rounded-lg'>
            ...
            <p className='text-muted-foreground'>
              Ces conditions s&apos;appliquent à tous les visiteurs, utilisateurs
              et autres personnes qui accèdent ou utilisent le service.
            </p>
          </section>
          ...
          <section className='space-y-6'>
            <div className='bg-background border border-border rounded-lg p-6'>
              ...
              <div className='space-y-3 text-sm text-muted-foreground'>
                ...
                <p>
                  • Vous ne devez pas transmettre de virus ou de code malveillant
                </p>
              </div>
            </div>
            ...
            <div className='bg-background border border-border rounded-lg p-6'>
              ...
              <div className='space-y-3 text-sm text-muted-foreground'>
                <p>
                  • Toutes les commandes sont soumises à acceptation de notre part
                </p>
                <p>
                ...
                <p>
                  • Nous nous réservons le droit de refuser toute commande
                </p>
              </div>
            </div>
            ...
            <div className='bg-background border border-border rounded-lg p-6'>
              ...
              <div className='space-y-3 text-sm text-muted-foreground'>
                ...
                <p>
                  • Vous ne pouvez pas reproduire ou distribuer notre contenu sans
                  autorisation
                </p>
                <p>
            ...
            <div className='bg-background border border-border rounded-lg p-6'>
              ...
              <div className='space-y-3 text-sm text-muted-foreground'>
                ...
                <p>
                  • Nous ne garantissons pas l&apos;absence d&apos;erreurs sur le
                  site
                </p>
                <p>
            ...
            <div className='bg-background border border-border rounded-lg p-6'>
              ...
              <div className='space-y-3 text-sm text-muted-foreground'>
                ...
                <p>
                  • L&apos;utilisation continue du site constitue une acceptation
                  des modifications
                </p>
              </div>
            </div>
            ...
            <div className='bg-background border border-border rounded-lg p-6'>
              ...
              <div className='space-y-3 text-sm text-muted-foreground'>
                ...
                <p>
                  • En cas de conflit, la version française prévaut
                </p>
                <p>
