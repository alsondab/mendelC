            ...
            <div className='bg-background border border-border rounded-lg p-6'>
              ...
              <div className='space-y-3'>
                <div className='border-b border-border pb-3'>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Guides d&apos;installation fournis avec chaque produit. Support
                ...
                <div className='border-b border-border pb-3'>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    ...
                    fabricant (1-3 ans selon le produit).
                  </p>
                </div>
                <div>
                  <h4 className='font-semibold text-foreground mb-2'>
          ...
          <section className='bg-background border border-border rounded-lg p-6'>
            ...
            <div className='space-y-4'>
              ...
              <div className='border-b border-border pb-4'>
                ...
                <p className='text-sm text-muted-foreground'>
                  Oui, pour les commandes importantes ou les entreprises. Contactez
