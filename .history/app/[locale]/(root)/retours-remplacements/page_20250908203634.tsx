      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='bg-muted/50 p-6 rounded-lg'>
          <p className='text-muted-foreground text-lg'>
            ...
            Si vous n&apos;êtes pas entièrement satisfait de votre achat, nous facilitons 
            les retours et remplacements. Tous les retours sont gratuits et faciles à effectuer.
          </p>
        </div>
      </div>
    </div>
