...
export const metadata: Metadata = {
  ...
  description: 'Découvrez notre politique de retour simple et flexible pour tous vos achats.',
}
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-foreground mb-8">Politique de Retour</h1>
        
        <div className="space-y-8">
          <section className="bg-muted/50 p-6 rounded-lg">
            <h2 className="text-2xl font-semibold text-foreground mb-4">Retours et échanges</h2>
            <p className="text-muted-foreground mb-4">
              Nous nous engageons à vous offrir une expérience d&apos;achat satisfaisante. 
              Notre politique de retour flexible vous permet de retourner ou échanger vos articles 
          ...
          <section className="grid md:grid-cols-2 gap-6">
            <div className="bg-background border border-border rounded-lg p-6">
              <h3 className="text-xl font-semibold text-foreground mb-4">Conditions de retour</h3>
            ...
            <div className="bg-background border border-border rounded-lg p-6">
              <h3 className="text-xl font-semibold text-foreground mb-4">Processus de retour</h3>
              <div className="space-y-3 text-sm">
          ...
          <section className="bg-background border border-border rounded-lg p-6">
            <h3 className="text-xl font-semibold text-foreground mb-4">Remboursements</h3>
          ...
          <section className="bg-muted/50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold text-foreground mb-4">Contact pour les retours</h3>
