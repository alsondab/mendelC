...
export const metadata: Metadata = {
  ...
  description:
    'Suivez votre commande en temps réel et obtenez des mises à jour sur l&apos;état de votre livraison.',
}
        ...
        <div className="space-y-8">
          <section className="bg-muted/50 p-6 rounded-lg">
            ...
            <p className="text-muted-foreground mb-4">
              Entrez votre numéro de commande ou de suivi pour obtenir des
              informations en temps réel sur l&apos;état de votre livraison.
            </p>
          </section>
