  ...
  return (
    <>
      ...
      <div className='md:p-4 md:space-y-4 bg-border'>
        ...
        <Card className='w-full rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 bg-gradient-to-br from-orange-50 to-red-50 border border-orange-200/50 overflow-hidden animate-pulse-glow'>
          <CardContent className='p-6 items-center gap-4 relative'>
