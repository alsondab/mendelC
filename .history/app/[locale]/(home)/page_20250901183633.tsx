  ...
  return (
    <>
      ...
      <div className='md:p-4 md:space-y-4 bg-border'>
        ...
        <Card className='w-full rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-orange-50 to-red-50 border border-orange-200/50 overflow-hidden'>
          <CardContent className='p-6 relative'>
            ...
            <div className='absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-orange-100/30 to-red-100/30 rounded-full translate-y-12 -translate-x-12'></div>
            
            {/* Animated title section */}
            <div className='relative z-10 mb-6'>
              <div className='flex items-center justify-between'>
                <div className='flex items-center space-x-3'>
                  <div className='w-8 h-8 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center animate-pulse'>
