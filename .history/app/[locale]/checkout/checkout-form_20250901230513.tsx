  ...
  const CheckoutSummary = () => (
    <Card className='sticky top-4'>
      <CardContent className='p-3 xs:p-4 sm:p-6'>
        {!isAddressSelected && (
          <div className='border-b border-muted mb-4 pb-4'>
            <Button
        ...
        {isAddressSelected && !isPaymentMethodSelected && (
          <div className='mb-4 pb-4'>
            ...
            <p className='text-xs xs:text-sm text-center py-2 text-muted-foreground'>
              Choisissez une méthode de paiement pour continuer. Vous pourrez encore
        ...
        <div>
          <h3 className='text-base xs:text-lg font-bold mb-4'>Résumé de la commande</h3>
          <div className='space-y-3'>
            ...
            <div className='flex justify-between text-sm xs:text-base'>
              <span>Livraison & manutention:</span>
              <span>
            ...
            {isAddressSelected && shippingAddress ? (
              ...
              <div className='p-3 xs:p-4 sm:p-6'>
                <div className='flex items-center gap-2 mb-4'>
                  ...
                  <h2 className='text-lg xs:text-xl font-bold text-primary'>Saisir l'adresse de livraison</h2>
                </div>
            ...
            {isPaymentMethodSelected && paymentMethod ? (
              ...
              <div className='p-3 xs:p-4 sm:p-6'>
                <div className='flex items-center gap-2 mb-4'>
                  ...
                  <h2 className='text-lg xs:text-xl font-bold text-primary'>Choisir une méthode de paiement</h2>
                </div>
                <div className='bg-muted/30 rounded-lg p-3 xs:p-4 space-y-4'>
                  <RadioGroup
                    value={paymentMethod}
                  ...
                  >
                    {availablePaymentMethods.map((pm) => (
                      <div key={pm.name} className='flex items-center space-x-3 p-2 rounded-lg hover:bg-muted/50 transition-colors'>
                        ...
                        />
                        <Label
                          className='font-semibold text-sm xs:text-base cursor-pointer flex-1'
              ...
              <div className='p-3 xs:p-4 sm:p-6'>
                <div className='flex items-center gap-2'>
                  ...
                  <h2 className='text-lg xs:text-xl font-bold text-muted-foreground'>Choisir une méthode de paiement</h2>
                </div>
              </div>
            )}
          </div>
            ...
            <div className='mt-4 xs:mt-6'>
              ...
              <Card className='hidden lg:block'>
                <CardContent className='p-3 xs:p-4 flex flex-col sm:flex-row justify-between items-center gap-3'>
                  <Button onClick={handlePlaceOrder} className='rounded-full text-sm xs:text-base'>
                    Passer la commande
                  </Button>
