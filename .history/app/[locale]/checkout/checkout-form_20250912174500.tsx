                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    placeholder="Saisir la commune/quartier"
                                    className="text-sm xs:text-base"
                                    maxLength={50}
                                    {...field}
                                  />
                                ...
                                <FormControl>
                                  <PhoneInput
                                    ...
                                    onChange={(e) => {
                                      ...
                                      // Supprimer TOUS les +225 présents (l'utilisateur ne doit pas les saisir)
                                      while (value.includes('+225')) {
                                        value = value.replace('+225', '').trim()
                                      }
                                      ...
                                      // Formater avec des espaces et ajouter +225 automatiquement
                                      if (value.length > 0) {
                                        const formatted = value.replace(
                                          /(\d{2})(\d{2})(\d{2})(\d{2})(\d{2})/,
                                          '$1 $2 $3 $4 $5'
                                        )
                                        field.onChange('+225 ' + formatted)
                                      } else {
                                        field.onChange('+225 ')
                                      }
                                    }}
