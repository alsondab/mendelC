        ...
        {!isAddressSelected && (
          <div className='border-b border-gray-200 mb-4 pb-4'>
            ...
            <p className='text-xs xs:text-sm text-center py-2 text-muted-foreground'>
              Choisissez une adresse de livraison et un mode de paiement pour
              calculer les frais de port, de manutention et les taxes.
            </p>
          </div>
        )}
        ...
        {isAddressSelected && !isPaymentMethodSelected && (
          <div className='border-b border-gray-200 mb-4 pb-4'>
            ...
            <p className='text-xs xs:text-sm text-center py-2 text-muted-foreground'>
              ...
              réviser et modifier votre commande avant qu&apos;elle ne soit
              finale.
            </p>
          </div>
        )}
        ...
        <div className='space-y-4'>
          ...
          <div className='space-y-3'>
            <div className='flex justify-between items-center'>
              <span className='text-sm xs:text-base text-muted-foreground'>
                Articles:
              </span>
