  ...
  const CheckoutSummary = () => (
    <Card className='sticky top-4'>
      <CardContent className='p-3 xs:p-4'>
        {!isAddressSelected && (
          <div className='border-b border-muted mb-3 xs:mb-4 pb-3 xs:pb-4'>
            <Button
              className='rounded-lg w-full text-sm xs:text-base'
              onClick={handleSelectShippingAddress}
            >
              Livrer à cette adresse
            </Button>
            <p className='text-xs xs:text-sm text-center py-2 text-muted-foreground'>
              Choisissez une adresse de livraison et un mode de paiement pour calculer
              les frais de livraison, de manutention et les taxes.
            </p>
          </div>
        )}
        {isAddressSelected && !isPaymentMethodSelected && (
          <div className='mb-3 xs:mb-4'>
            ...
            <p className='text-xs xs:text-sm text-center py-2 text-muted-foreground'>
              Choisissez un mode de paiement pour continuer. Vous pourrez encore
              réviser et modifier votre commande avant qu'elle ne soit finale.
            </p>
          </div>
        )}
        {isPaymentMethodSelected && isAddressSelected && (
          <div>
            <Button onClick={handlePlaceOrder} className='rounded-lg w-full text-sm xs:text-base'>
              Passer la commande
            </Button>
            <p className='text-xs xs:text-sm text-center py-2 text-muted-foreground'>
        ...
        <div className='mt-4 xs:mt-6'>
          <div className='text-base xs:text-lg font-bold text-foreground mb-3 xs:mb-4'>
          ...
          <div className='space-y-2 xs:space-y-3'>
            ...
            <div className='flex justify-between pt-3 xs:pt-4 border-t border-muted font-bold text-base xs:text-lg'>
              <span className='text-foreground'>Total de la commande:</span>
        ...
        <div className='lg:col-span-3 space-y-4 xs:space-y-6'>
          ...
          <div>
            {isAddressSelected && shippingAddress ? (
              <div className='bg-card rounded-xl border shadow-sm p-3 xs:p-4 sm:p-6'>
                <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3'>
                  <div className='flex items-center gap-2'>
                    <div className='w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-bold'>
                      1
                    </div>
                    <h3 className='text-base xs:text-lg font-bold text-foreground'>
                ...
                <div className='mt-3 xs:mt-4 p-3 xs:p-4 bg-muted/30 rounded-lg'>
              ...
              <>
                <div className='bg-card rounded-xl border shadow-sm p-3 xs:p-4 sm:p-6'>
                  ...
                  <Form {...shippingAddressForm}>
                    ...
                    >
                      <div className='bg-muted/30 rounded-lg p-3 xs:p-4 space-y-3 xs:space-y-4'>
                        <div className='text-base xs:text-lg font-bold text-foreground mb-3'>
                          Votre adresse
                        </div>
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 xs:gap-4'>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className='w-full'>
                                <FormLabel className='text-sm xs:text-base'>Numéro de téléphone</FormLabel>
                                <FormControl>
                                  <Input
                      ...
                      <div className='pt-3 xs:pt-4'>
                        <Button
                          type='submit'
                          className='w-full rounded-lg font-semibold text-sm xs:text-base'
                        >
                          Livrer à cette adresse
                        </Button>
                      </div>
            ...
            <div className='mt-4 xs:mt-6'>
              ...
              <Card className='hidden lg:block'>
                <CardContent className='p-4 flex flex-col lg:flex-row justify-between items-center gap-3'>
                  <Button onClick={handlePlaceOrder} className='rounded-lg w-full lg:w-auto'>
                    Passer la commande
                  </Button>
                  <div className='flex-1 text-center lg:text-right'>
                    <p className='font-bold text-base xs:text-lg'>
                      Total de la commande: <ProductPrice price={totalPrice} plain />
                    </p>
