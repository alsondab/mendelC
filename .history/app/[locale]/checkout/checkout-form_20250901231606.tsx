...
const CheckoutForm = () => {
  ...
  const CheckoutSummary = () => (
    <Card className='sticky top-4'>
      <CardContent className='p-3 xs:p-4 sm:p-6 space-y-4'>
        {!isAddressSelected && (
        ...
        {isAddressSelected && !isPaymentMethodSelected && (
          <div className='border-b border-muted pb-4 mb-4'>
            ...
            <p className='text-xs xs:text-sm text-center py-2 text-muted-foreground'>
              Choisissez une méthode de paiement pour continuer. Vous pourrez
              encore réviser et modifier votre commande avant qu'elle ne soit finale.
            </p>
          </div>
        )}
        ...
        <div>
          <h3 className='text-base xs:text-lg font-bold mb-3'>Résumé de la commande</h3>
          <div className='space-y-2 text-sm xs:text-base'>
            ...
            <div className='flex justify-between pt-3 border-t border-muted font-bold text-base xs:text-lg'>
            ...
            {isDeliveryDateSelected && deliveryDateIndex != undefined ? (
              ...
              <div className='p-3 xs:p-4 sm:p-6'>
                <div className='flex items-center gap-2 mb-4'>
                  ...
                  <h2 className='text-lg xs:text-xl font-bold'>Réviser les articles et la livraison</h2>
                </div>
                <div className='bg-muted/30 rounded-lg p-3 xs:p-4 space-y-4'>
                  <p className='text-sm xs:text-base'>
                    ...
                    Si vous commandez dans les {timeUntilMidnight().hours} heures
          ...
          {isPaymentMethodSelected && isAddressSelected && (
            <div className='bg-card rounded-xl border shadow-sm p-3 xs:p-4 sm:p-6'>
              <div className='flex flex-col sm:flex-row justify-between items-center gap-4'>
                <Button onClick={handlePlaceOrder} className='rounded-full w-full sm:w-auto text-sm xs:text-base'>
                  Passer la commande
                </Button>
