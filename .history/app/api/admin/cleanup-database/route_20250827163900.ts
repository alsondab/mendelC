...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!authResult.authorized) {
      console.warn(`🔒 Accès refusé à /api/admin/cleanup-database: ${authResult.error}`)
    ...
    console.log(`🔓 Accès autorisé à /api/admin/cleanup-database pour l'utilisateur: ${authResult.user?.email}`)
